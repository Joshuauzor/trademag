					...
					<div>
						...
						<div class="row text-center">
							<h2 class="title-head hidden-xs">Reset <span>Password</span></h2>
							 <p class="info-form">Change your password by entering new password</p>
						</div>
						<!-- Section Title Ends -->
						<!-- Form Starts -->
						<?= form_open() ?>
						<!-- <form action="<?= base_url('auth/reset') ?>" method="post"> -->
                            ...
                            <div class="form-group">
								<input class="form-control" name="confirm_password" id="email" placeholder="Confirm Password" type="password" required>
							</div>
							<!-- Submit Form Button Starts -->
							<div class="form-group">
								<button class="btn btn-primary" type="submit">Submit</button>
								<p class="text-center">Back to login ? <a href="<?= base_url('login') ?>">Click here</a>
							</div>
