					...
					<div>
						...
						<form action="<?= base_url('auth/login') ?>" method="post">
							...
							<div class="form-group">
								...
								<p class="text-center">don't have an account ? <a href="<?= base_url('register') ?>">register now</a>
								<p class="text-center">forgot password ? <a href="<?= base_url('forgot') ?>">Click here</a>
							</div>
