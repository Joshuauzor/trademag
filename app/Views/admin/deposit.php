        ...
        <div class="content-body"><!-- Basic example section start -->
            ...
            <section id="sizing">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="text" id="bitcoinWalID" class="form-control float-left" value="h9bgu854PN9KqV6" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Bitcoin Wallet ID" data-original-title="" title="" readonly>
                    </div>
                    <div class="col-md-2">
                                        ...
                                        <form class="form" method="post" action="<?= base_url('users/deposit') ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="amount" class="form-control" value="" placeholder="amount" name="amount" required readonly>
                                                </div>
