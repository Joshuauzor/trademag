  ...
  <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Declined Deposit</h2>
          </div>
          <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Declined Deposit</a>
                </li>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Declined Deposit</h4>
                        ...
                        <div class="card-body collapse in">
                            <div class="card-block card-dashboard">
                                <p>View all declined deposit transaction history</p>
                                <!-- flash messages -->
                                <?= view('flashMessages') ?>
                                <!-- flash messages end -->
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped dataTable">
                                        ...
                                        <tbody>
                                        <?php $i = 0; foreach($declinedDeposit as $row): $i++ ?>
                                            <tr>
                                                <th scope="row">
                                                    <?= $i ?>
                                                </th>
