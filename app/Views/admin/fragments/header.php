      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item"><a href="<?= base_url('admin') ?>" class="navbar-brand nav-link"><img alt="branding logo" src="<?= base_url('public/logo3.png') ?>" data-expand="<?= base_url('public/logo3.png') ?>" data-collapse="<?= base_url('public/logo3.png') ?>" class="brand-logo" style="width: 219px"></a></li>
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            ...
            <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="flag-icon"></i><span class="selected-language">Admin</span></a>
              </li>
