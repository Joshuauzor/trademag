...
<div class="app-content content container-fluid">
  <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Pending Withdrawal</h2>
          </div>
                                    ...
                                    <table class="table table-bordered table-striped dataTable">
                                        ...
                                        <?php $i = 0; foreach($pendingWithdrawal as $row): $i++ ?>
                                            <tr>
                                                ...
                                                <td> <?= $row->method ?> </td>
                                                <td>
                                                    <button type="button" class="btn btn-success btn-sm" data-userId="<?= $row->invested_id ?>" onclick="approveWithdrawal('<?= $row->invested_id ?>')" id="accept">Accept</button>
 ...
 <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script>
            function approveWithdrawal(investedId){
